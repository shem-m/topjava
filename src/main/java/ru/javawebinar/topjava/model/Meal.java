...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.FILTERED, query = "SELECT m FROM Meal m LEFT JOIN FETCH m.user WHERE  m.user.id=:userId  AND m.dateTime >=:startDateTime AND m.dateTime <:endDateTime ORDER BY m.dateTime DESC"),
